...
if __name__ == "__main__":
    ...
    if (args.env == 'production'):
        socketio.run(app, host="0.0.0.0", port=443, keyfile="/etc/letsencrypt/live/api.onebob.co/privkey.pem", certfile="/etc/letsencrypt/live/api.onebob.co/chain.pem", debug=True)
    else:
